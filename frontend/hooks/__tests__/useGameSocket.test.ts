...
// ---------------------------------------------------------------------------
import { useGameSocket, type GameState } from '../useGameSocket'
...
describe('useGameSocket', () => {
  ...
  it('game_tick with events appends them to the events array', async () => {
    ...
    act(() => {
      getLastWs().simulateMessage({
        ...
        players: baseGameState.players,
        events: [
          { type: 'unit_produced', player_id: 'p1', region_id: 'r1', unit_type: 'infantry', quantity: 2 },
        ],
      })
    })
  ...
  it('chat_history replaces matchChatMessages', async () => {
    ...
    const history = [
      { user_id: 'p2', username: 'Bob', content: 'Historical', timestamp: 500 },
    ]
  ...
  it('selectCapital() sends select_capital action', async () => {
    ...
    act(() => { result.current.selectCapital('r1') })
  ...
  it('attack() sends attack action with all fields', async () => {
    ...
    act(() => { result.current.attack('r1', 'r2', 5, 'infantry') })
  ...
  it('move() sends move action', async () => {
    ...
    act(() => { result.current.move('r1', 'r2', 3, null) })
  ...
  it('build() sends build action', async () => {
    ...
    act(() => { result.current.build('r1', 'barracks') })
  ...
  it('produceUnit() sends produce_unit action', async () => {
    ...
    act(() => { result.current.produceUnit('r1', 'tank') })
  ...
  it('useAbility() sends use_ability action', async () => {
    ...
    act(() => { result.current.useAbility('r2', 'nuke') })
