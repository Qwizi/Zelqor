...
vi.mock('lucide-react', () => ({
  ...
  X: ({ className }: { className?: string }) =>
    React.createElement('span', { 'data-testid': 'icon-x', className }),
...
describe('MatchChatPanel', () => {
  ...
  it('shows unread badge when new messages arrive while chat is collapsed', () => {
    ...
    const desktopToggle = screen.getAllByText('Czat meczu')
  ...
  it('does not show unread count for own messages', () => {
    ...
    // Collapse the panel
    const toggles = screen.getAllByText('Czat meczu').map((el) => el.closest('button')).filter(Boolean)
