...
vi.mock('recharts', () => ({
  Area: ({ dataKey }: { dataKey: string }) =>
    React.createElement('div', { 'data-testid': `recharts-area-${dataKey}` }),
...
vi.mock('@/components/ui/chart', () => ({
  ...
  ChartTooltipContent: () =>
    React.createElement('div', { 'data-testid': 'chart-tooltip-content' }),
}))
...
function makeMatch(overrides: Partial<Match> = {}): Match {
  return {
    ...
    winner_id: USER_ID,
    players: [
      { id: 'mp1', user_id: USER_ID, username: 'Me', color: '#22d3ee', is_alive: false, joined_at: '', is_banned: false },
      { id: 'mp2', user_id: 'opp', username: 'Opp', color: '#fbbf24', is_alive: false, joined_at: '', is_banned: false },
    ],
