...
describe("GameNotificationOverlay", () => {
  ...
  it("renders nothing when notifications array is empty", () => {
    const { container } = render(React.createElement(GameNotificationOverlay, { notifications: [], onDismiss: noop }));
  ...
  it("renders the overlay container when notifications exist", () => {
    ...
    render(React.createElement(GameNotificationOverlay, { notifications, onDismiss: noop }));
  ...
  it("calls onDismiss with the correct id when a notification is clicked", async () => {
    ...
    render(React.createElement(GameNotificationOverlay, { notifications, onDismiss: dismissFn }));
