...
describe("VoicePanel", () => {
  ...
  it("renders nothing when token is null", () => {
    const { container } = render(React.createElement(VoicePanel, { ...defaultProps, token: null }));
    expect(container.firstChild).toBeNull();
  });

  it("renders nothing when url is null", () => {
    const { container } = render(React.createElement(VoicePanel, { ...defaultProps, url: null }));
    expect(container.firstChild).toBeNull();
  });

  it("renders nothing when both token and url are null", () => {
    const { container } = render(React.createElement(VoicePanel, { ...defaultProps, token: null, url: null }));
    expect(container.firstChild).toBeNull();
  });
