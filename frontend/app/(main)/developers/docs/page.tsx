...

{
  ...
  "results": [ ... ]
      ...
      <section id="oauth2" className="space-y-4">
        ...
        <SectionDescription>
          OAuth2 Authorization Code Flow pozwala Twojej aplikacji dzialac w imieniu uzytkownika Zelqor po uzyskaniu jego
          zgody. Uzywaj tego przepływu, gdy potrzebujesz dostepu do danych konkretnego gracza.
        </SectionDescription>
