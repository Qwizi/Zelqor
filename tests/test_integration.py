            ...
            "/api/v1/internal/game/finalize/",
            {
                ...
                "final_state": {
                    ...
                    "players": {
                        winner_id: {
                            "is_alive": True,
                            "total_regions_conquered": 8,
                            "total_units_produced": 40,
                            "total_units_lost": 5,
                            "total_buildings_built": 4,
                        },
                        loser_id: {
                            "is_alive": False,
                            "total_regions_conquered": 3,
                            "total_units_produced": 15,
                            "total_units_lost": 15,
                            "total_buildings_built": 1,
                        },
                    },
    ...
    def _internal_endpoints(self):
        ...
        return [
            ...
            (
                "POST",
                "/api/v1/internal/game/finalize/",
                {"match_id": mid, "winner_id": uid, "total_ticks": 1, "final_state": {}},
            ),
