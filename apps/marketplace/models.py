...
class MarketConfig(models.Model):
    ...
    def get_effective_config(cls):
        ...
        return {
            "transaction_fee": get_module_config(
                "marketplace", "transaction_fee_percent", obj.transaction_fee_percent if obj else 5.0
            ),
            "listing_duration_hours": get_module_config(
                "marketplace", "listing_duration_hours", obj.listing_duration_hours if obj else 72
            ),
            "max_active_listings": get_module_config(
                "marketplace", "max_active_listings_per_user", obj.max_active_listings_per_user if obj else 20
            ),
        }
