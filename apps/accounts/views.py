...
class AuthController:
    ...
    def register(self, payload: RegisterSchema):
        ...
        try:
            ...
            raise HttpError(400, "Nie mozna utworzyc konta. Sprobuj ponownie.") from None
        ...
        try:
            ...
            STARTER_SLUGS = get_module_config(
                "registration",
                "starter_items",
                [
                    "pkg-shield-1",
    ...
    def me(self, request):
        ...
        avg_placement = PlayerResult.objects.filter(user=user).aggregate(avg=Avg("placement"))["avg"] or 0.0
