...
from apps.crafting.schemas import CraftingLogOutSchema, CraftInSchema, RecipeOutSchema
...
class CraftingController:
    ...
    def crafting_history(self, request, limit: int = 50, offset: int = 0):
        ...
        qs = CraftingLog.objects.filter(user=request.user).select_related(
            "recipe", "result_item", "result_item__category"
        )
