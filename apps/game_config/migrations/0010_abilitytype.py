    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_type', models.CharField(choices=[('enemy', 'Enemy'), ('own', 'Own'), ('any', 'Any')], default='enemy', max_length=10)),
                ...
                ('effect_params', models.JSONField(blank=True, default=dict, help_text='Per-ability params: production_reduction, unit_kill_percent, spread_range, collect_percent')),
