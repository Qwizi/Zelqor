    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.JSONField(blank=True, default=dict, help_text='Module-specific configuration as JSON')),
                ('config_schema', models.JSONField(blank=True, default=list, help_text='Describes available config fields for admin UI')),
