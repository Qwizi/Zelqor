    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "starting_currency",
                    models.PositiveIntegerField(default=120, help_text="Starting strategic currency for each player"),
                ),
                (
                    "base_currency_per_tick",
                    models.FloatField(default=2.0, help_text="Base currency generated per tick for each player"),
                ),
                (
                    "region_currency_per_tick",
                    models.FloatField(default=0.35, help_text="Currency generated per owned region each tick"),
                ),
                ...
                (
                    "neutral_region_units",
                    models.PositiveIntegerField(default=3, help_text="Garrison units in unowned (neutral) regions"),
                ),
