...
MODULES = [
    {
        ...
        "config_schema": [
            {
                "key": "storm_randomness_modifier",
                "label": "Storm combat chaos",
                "type": "float",
                "default": 1.4,
                "min": 1.0,
                "max": 3.0,
            ...
            {
                "key": "fog_randomness_modifier",
                "label": "Fog combat chaos",
                "type": "float",
                "default": 1.25,
                "min": 1.0,
                "max": 3.0,
            ...
            {
                "key": "rain_randomness_modifier",
                "label": "Rain combat chaos",
                "type": "float",
                "default": 1.1,
                "min": 1.0,
                "max": 3.0,
            ...
            {
                "key": "storm_energy_modifier",
                "label": "Storm energy modifier",
                "type": "float",
                "default": 0.85,
                "min": 0.0,
                "max": 2.0,
            ...
            {
                "key": "rain_energy_modifier",
                "label": "Rain energy modifier",
                "type": "float",
                "default": 0.95,
                "min": 0.0,
                "max": 2.0,
            ...
            {
                "key": "storm_unit_gen_modifier",
                "label": "Storm unit gen modifier",
                "type": "float",
                "default": 0.90,
                "min": 0.0,
                "max": 2.0,
            ...
            {
                "key": "rain_unit_gen_modifier",
                "label": "Rain unit gen modifier",
                "type": "float",
                "default": 0.95,
                "min": 0.0,
                "max": 2.0,
    ...
    },
    {
        ...
        "config_schema": [
            {
                "key": "night_defense_modifier",
                "label": "Night defense bonus",
                "type": "float",
                "default": 1.15,
                "min": 1.0,
                "max": 3.0,
            ...
            {
                "key": "dawn_dusk_defense_modifier",
                "label": "Dawn/dusk defense bonus",
                "type": "float",
                "default": 1.05,
                "min": 1.0,
                "max": 3.0,
    ...
    },
    {
        ...
        "config_schema": [
            {
                "key": "attacker_advantage",
                "label": "Attacker advantage",
                "type": "float",
                "default": 0.0,
                "min": 0.0,
                "max": 1.0,
            ...
            {
                "key": "defender_advantage",
                "label": "Defender advantage",
                "type": "float",
                "default": 0.1,
                "min": 0.0,
                "max": 1.0,
            ...
            {
                "key": "combat_randomness",
                "label": "Combat randomness",
                "type": "float",
                "default": 0.2,
                "min": 0.0,
                "max": 1.0,
    ...
    },
    {
        ...
        "config_schema": [
            ...
            {
                "key": "base_energy_per_tick",
                "label": "Base energy/tick",
                "type": "float",
                "default": 2.0,
                "min": 0.0,
                "max": 100.0,
            ...
            {
                "key": "region_energy_per_tick",
                "label": "Energy per region/tick",
                "type": "float",
                "default": 0.35,
                "min": 0.0,
                "max": 10.0,
            ...
            {
                "key": "base_unit_generation_rate",
                "label": "Base unit gen rate",
                "type": "float",
                "default": 1.0,
                "min": 0.0,
                "max": 100.0,
            ...
            {
                "key": "capital_generation_bonus",
                "label": "Capital gen bonus",
                "type": "float",
                "default": 2.0,
                "min": 0.0,
                "max": 100.0,
    ...
    },
    {
        ...
        "config_schema": [
            {
                "key": "max_build_queue_per_region",
                "label": "Max build queue/region",
                "type": "int",
                "default": 3,
                "min": 1,
                "max": 20,
            ...
            {
                "key": "max_unit_queue_per_region",
                "label": "Max unit queue/region",
                "type": "int",
                "default": 4,
                "min": 1,
                "max": 20,
    ...
    },
    {
        ...
        "config_schema": [
            {
                "key": "snapshot_interval_ticks",
                "label": "Snapshot interval (ticks)",
                "type": "int",
                "default": 30,
                "min": 5,
                "max": 300,
